                        ...
                        <li>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="divider"></li>
                                <li><a href="${pageContext.request.contextPath}/login?signOut=signOut">Đăng xuất</a></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
    ...
    <div class="sidebar-nav navbar-collapse slimscrollsidebar">
        <ul class="nav" id="side-menu">
            <li style="padding: 10px 0 0;">
                <a href="${pageContext.request.contextPath}/index" class="waves-effect">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-megna" role="progressbar"
                                            aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: ${dangthuchien}%">
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <c:forEach var="userEntry" items="${userTaskMap}">
            <!-- Header của từng người dùng -->
            <div class="row">
                <div class="col-xs-12">
                    <a href="#" class="group-title">
                        <img width="30" src="${userEntry.value[0].avatarImage}" class="img-circle" />
                        <span>${userEntry.value[0].userName}</span>
                    </a>
                </div>
            </div>
                ...
                <div class="col-md-4">
                    <div class="white-box">
                        ...
                        <div class="message-center">
                            <c:forEach var="task" items="${userEntry.value}">
                                <c:if test="${task.statusId == '1'}">
                                    <a href="#">
                                        <div class="mail-contnet">
                                            <h5>Dự Án: ${task.jobName}</h5>
                                            <h5>Tên Công: Việc ${task.taskName}</h5>
                                            <span class="mail-desc">Bắt đầu: ${task.taskStartDate}, Kết thúc: ${task.taskEndDate}</span>
                                        </div>
                                    </a>
                                </c:if>
                            </c:forEach>
