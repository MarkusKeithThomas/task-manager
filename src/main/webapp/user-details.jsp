            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                        <div class="white-box">
                            <div class="user-bg"> <img width="100%" alt="user" src="${imageURL != null ? imageURL : 'plugins/images/large/img1.jpg'}">
            ...
            <c:if test="${task.statusId == 1}">
                <a href="#">
                    <div class="mail-contnet">
                        <h5>${task.taskName}</h5>
                        <span class="time">Bắt đầu: ${task.taskStartDate}</span>
                        <span class="time">Kết thúc: ${task.taskEndDate}</span>
                    </div>
                </a>
            </c:if>
        </c:forEach>
