                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form class="form-horizontal form-material" method="POST">
                                ...
                                <div class="form-group">
                                    <label class="col-md-12">Link Cloud Anh</label>
                                    <div class="col-md-12">
                                        <input type="text" name="iamge" placeholder="https://www.google.com/url?sa=i&url=https%3A%2F%2Fchiemtaimobile.vn%2Ftin-cong-nghe%2Favatar-facebook-dep%2F&psig=AOvVaw2FBPS8PqI463fCr5dA85O1&ust=1732170965104000&source=images&cd=vfe&opi=89978449&ved=0CBEQjRxqFwoTCLCLlOql6okDFQAAAAAdAAAAABAE"
                                            class="form-control form-control-line"> </div>
                                </div>
                                <div class="form-group">
